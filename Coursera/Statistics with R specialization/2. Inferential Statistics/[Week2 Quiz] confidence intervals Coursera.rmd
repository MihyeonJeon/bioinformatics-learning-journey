...
samp %>% summarise(mean_area = mean(area))
hist(samp, breaks = 20)
...
# 90% of my confidence intervals include the true mean of population, which is not exactly equal. As I only used 50 samples of size 60.
