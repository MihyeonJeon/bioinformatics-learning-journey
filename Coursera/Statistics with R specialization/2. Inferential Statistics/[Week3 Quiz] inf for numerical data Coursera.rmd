...
# Answer 3 : 3. Both distributions are extremely right skewed.
...
inference(y = weeks, data = nc, statistic = "mean",
          type = "ci", method = "theoretical", conf_level = 0.99)
...
inference(y = weeks, data = nc, statistic = "mean",
          type = "ci", method = "theoretical", conf_level = 0.9)

#The width of the interval at 90% confidence level is narrower than at 99% confidence level.
...
ggplot(data = nc, aes(x = mature, y = mage)) +
  geom_boxplot()

# Following the boxplot, the cut-off value for younger mom is till 30 years old and for mature mom, it starts from 35 years old.
```
